...
6. 默认选股策略：默认只筛创业板，看板涨幅 3%-18.8%，板块评分筛选开启且不低于 78，昨日最高涨幅、避开近涨停和前日涨跌停过滤默认开启；日线多头、10日涨幅限制、成交量限制、60日新高、流通市值、换手和量比筛选默认关闭。
7. 可调前日条件：默认要求候选股前一交易日不能涨停或跌停，并可通过“昨日最高涨幅”控制前一日是否过度加速。
