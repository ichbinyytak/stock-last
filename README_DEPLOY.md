...
6. 默认选股策略：看板涨幅 3%-18.8%，换手 2%-25%，量比不低于 1，板块评分不低于 78，个股评分不低于 76，板块上涨广度不低于 45%，活跃家数不低于 3，日线多头开启，避开近涨停开启，偏好 20cm 开启。
7. 自动买入任务：交易日北京时间 14:45，对应 Cron `45 6 * * 1-5`。
8. 自动卖出任务：交易日北京时间 09:35，对应 Cron `35 1 * * 1-5`。
9. 策略只做模拟记录，不连接券商，不发送真实订单。
